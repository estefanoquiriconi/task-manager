...
<template>
  <div>
    ...
    <select
      v-model="model"
      class="block w-full cursor-pointer rounded-xl border bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500"
      :class="
        error
